...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-80 sm:py-96">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full text-green-600 mb-10">
